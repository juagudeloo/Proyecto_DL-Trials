...
def main():
    ...
    for i in range(4):
        ax[0,i].plot(np.arange(0,height,1)+1, atm_params[max_values[i][0][0], max_values[i][0][1], i])
        ax[0,i].title("Height serie in a maximum")
        ax[1,i].plot(np.arange(0,height,1)+1, atm_params[max_values[i][0][0], max_values[i][0][1], i])
