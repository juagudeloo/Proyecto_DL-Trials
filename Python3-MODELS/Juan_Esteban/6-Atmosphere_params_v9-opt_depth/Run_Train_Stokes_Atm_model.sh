...
python3	/girg/juagudeloo/Proyecto_DL-Trials/Python3-MODELS/Juan_Esteban/6-Atmosphere_params_v9-opt_depth/Begin_Train_Stokes-Atm_model.py 080000

for i in 087000 094000 101000 108000 115000
do
    python3	/girg/juagudeloo/Proyecto_DL-Trials/Python3-MODELS/Juan_Esteban/6-Atmosphere_params_v9-opt_depth/Train_Stokes-Atm_model.py $i
done
